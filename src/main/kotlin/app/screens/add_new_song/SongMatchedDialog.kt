...
fun SongMatchedDialog(
    ...
    if (isShowingDialog) {
        Dialog(
            state = dialogState,
            icon = painterResource("ic_dialog.png"),
            title = "",
            onCloseRequest = {
                onCancelClick()
            }
            ...
            Column(
                modifier = Modifier.fillMaxSize().background(appBg).padding(16.dp).verticalScroll(verticalScroll)
            ) {
